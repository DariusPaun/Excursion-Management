...
export function CreateEventPage() {
   ...
   const {toast} = useToast()
    ...
    const handleSubmit = async (e) => {
        ...
        // Validate Event Name
        if (!eventName) {
            setEventNameError('Numele evenimentului nu poate sa fie gol');
            isValid = false;
        }
    
        // Validate Start Date
        if (startDate < currentDate) {
            setStartDateError('Data de inceput incorectă');
            isValid = false;
        }
    ...
    return (
        <Tabs defaultValue="createEvent" className="w-[800px] mx-auto mt-[-275px]">
            ...
            <TabsContent value="createEvent">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Adaugă detaliile evenimentului</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="startDate">Dată plecare </Label>
                            <Input
                                id="startDate"
                                type="date"
                                value={startDate}
                            ...
                            />
                            <Label htmlFor="startTime">Oră plecare</Label>
                            <Input
                                id="startTime"
                                type="time"
                                value={startTime}
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="endDate">Dată sosire</Label>
                            <Input
                                id="endDate"
                                type="date"
                                value={endDate}
                            ...
                            />
                            <Label htmlFor="endTime">Oră sosire</Label>
                            <Input
                                id="endTime"
                                type="time"
                                value={endTime}
                        ...
                        <div className="space-y-1">
                            ...
                            >
                                <option value="">Mijloc de transport</option>
            ...
            <TabsContent value="createAttraction">
                <Card>
                    <CardHeader>
                        <CardTitle>Atracții</CardTitle>
                        <CardDescription>Adaugă o nouă atracție</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <form onSubmit={handleAttractionSubmit}>
                            ...
                            <div className="pt-4">
                                <Button type="submit">Crează Atracție</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent className="flex justify-center">
                        ...
                        <ScrollArea className="h-[400px] w-full rounded-md border">
                            <div className="p-4">
                                <h4 className="mb-4 text-sm font-medium leading-none">Atracții</h4>
